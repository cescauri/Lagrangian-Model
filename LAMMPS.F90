...
module LAMMPS
   ...
   public :: lammps_open, lammps_open_no_mpi, lammps_close, lammps_file, &
      ...
      lammps_les_get_coupling, &
      lammps_les_clear_particles, &
      lammps_les_add_particle, &
      lammps_les_scatter_particles, &
      lammps_les_run_until, &
      lammps_les_gather_particles, &
      lammps_les_get_particle, &
      lammps_les_create_restart_file
!      lammps_get_proc_xlo, lammps_get_proc_xhi, &
!      lammps_get_proc_ylo, lammps_get_proc_yhi, &
!      lammps_get_proc_zlo, lammps_get_proc_zhi
   ...
   interface
      ...
      subroutine lammps_les_get_coupling (lmpptr, lesptr) &
            bind (C, name = 'lammps_les_get_coupling')
         import :: C_ptr
         type (C_ptr), value :: lmpptr
         type (C_ptr) :: lesptr
      end subroutine lammps_les_get_coupling

      subroutine lammps_les_clear_particles (ptr, inumparticles) &
            bind (C, name = 'lammps_les_clear_particles')
         import :: C_ptr, C_int
         type (C_ptr), value :: ptr
         integer (C_int) :: inumparticles
      end subroutine lammps_les_clear_particles

      subroutine lammps_les_add_particle (ptr, vrhs, proc, id) &
            bind (C, name = 'lammps_les_add_particle')
         import :: C_ptr, C_double, C_int
         type (C_ptr), value :: ptr
         real (C_double), dimension(*) :: vrhs
         integer (C_int) :: proc, id
      end subroutine lammps_les_add_particle

      subroutine lammps_les_scatter_particles (ptr) &
            bind (C, name = 'lammps_les_scatter_particles')
         import :: C_ptr
         type (C_ptr), value :: ptr
      end subroutine lammps_les_scatter_particles

      subroutine lammps_les_run_until (ptr, new_time) &
            bind (C, name = 'lammps_les_run_until')
         import :: C_ptr, C_double
         type (C_ptr), value :: ptr
         real (C_double) :: new_time
      end subroutine lammps_les_run_until

      subroutine lammps_les_gather_particles (ptr) &
            bind (C, name = 'lammps_les_gather_particles')
         import :: C_ptr
         type (C_ptr), value :: ptr
      end subroutine lammps_les_gather_particles

      subroutine lammps_les_get_particle (ptr, xp, vp, omegap, proc, id) &
            bind (C, name = 'lammps_les_get_particle')
         import :: C_ptr, C_double, C_int
         type (C_ptr), value :: ptr
         real (C_double), dimension(*) :: xp, vp, omegap
         integer (C_int) :: proc, id
      end subroutine lammps_les_get_particle

      subroutine lammps_les_create_restart_file (ptr) &
            bind (C, name = 'lammps_les_create_restart_file')
         import :: C_ptr
         type (C_ptr), value :: ptr
      end subroutine lammps_les_create_restart_file

!      function lammps_get_proc_xlo (ptr) result (xlo) &
!      bind (C, name='lammps_get_proc_xlo')
!         import :: C_double, C_ptr
!         type (C_ptr), value :: ptr
!         real (C_double) :: xlo
!      end function lammps_get_proc_xlo
!      function lammps_get_proc_xhi (ptr) result (xhi) &
!      bind (C, name='lammps_get_proc_xhi')
!         import :: C_double, C_ptr
!         type (C_ptr), value :: ptr
!         real (C_double) :: xhi
!      end function lammps_get_proc_xhi
!      function lammps_get_proc_ylo (ptr) result (ylo) &
!      bind (C, name='lammps_get_proc_ylo')
!         import :: C_double, C_ptr
!         type (C_ptr), value :: ptr
!         real (C_double) :: ylo
!      end function lammps_get_proc_ylo
!      function lammps_get_proc_yhi (ptr) result (yhi) &
!      bind (C, name='lammps_get_proc_yhi')
!         import :: C_double, C_ptr
!         type (C_ptr), value :: ptr
!         real (C_double) :: yhi
!      end function lammps_get_proc_yhi
!      function lammps_get_proc_zlo (ptr) result (zlo) &
!      bind (C, name='lammps_get_proc_zlo')
!         import :: C_double, C_ptr
!         type (C_ptr), value :: ptr
!         real (C_double) :: zlo
!      end function lammps_get_proc_zlo
!      function lammps_get_proc_zhi (ptr) result (zhi) &
!      bind (C, name='lammps_get_proc_zhi')
!         import :: C_double, C_ptr
!         type (C_ptr), value :: ptr
!         real (C_double) :: zhi
!      end function lammps_get_proc_zhi
